...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 22 13:35:27 2021
...
ar = ar.drop(['d_id_3'], axis =1)

#Checking the first few rows of each entity;
print(f'ar.head(): \n{ar.groupby("hscode").head()}\n')
...
# Excl. = ddest_(1)
# Excl. = h_(1)
ar['u11c_t1'] = ar.d_id_1 * ar.h_11 *ar.ddest_2 *ar.tw1
ar['u11i_t1'] = ar.d_id_1 * ar.h_11 *ar.ddest_3 *ar.tw1
ar['u11j_t1'] = ar.d_id_1 * ar.h_11 *ar.ddest_4 *ar.tw1

ar['u11c_t2'] = ar.d_id_1 * ar.h_11 *ar.ddest_2 *ar.tw2
ar['u11i_t2'] = ar.d_id_1 * ar.h_11 *ar.ddest_3 *ar.tw2
ar['u11j_t2'] = ar.d_id_1 * ar.h_11 *ar.ddest_4 *ar.tw2

ar['u12c_t1'] = ar.d_id_1 * ar.h_12 *ar.ddest_2 *ar.tw1
ar['u12i_t1'] = ar.d_id_1 * ar.h_12 *ar.ddest_3 *ar.tw1
ar['u12j_t1'] = ar.d_id_1 * ar.h_12 *ar.ddest_4 *ar.tw1

ar['u12c_t2'] = ar.d_id_1 * ar.h_12 *ar.ddest_2 *ar.tw2
ar['u12i_t2'] = ar.d_id_1 * ar.h_12 *ar.ddest_3 *ar.tw2
ar['u12j_t2'] = ar.d_id_1 * ar.h_12 *ar.ddest_4 *ar.tw2

ar['uh11rpc19'] = ar.d_id_1 * ar.h_11 * ar.rp_e * ar.covid
ar['uh12rpc19'] = ar.d_id_1 * ar.h_12 * ar.rp_e * ar.covid 

#Using 'd_id_1' to indicate that we are specifying exports 
# originating from the United States;
# FE model estimation:
print('Articles Group Estimation: United States')
print('Fixed Effects: Results')
reg_feu = plm.PanelOLS.from_formula(formula='qpc ~ d_id_1 + ddest_2 +ddest_3'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+u11c_t1 +u11i_t1 +u11j_t1'
                                '+u11c_t2 +u11i_t2 +u11j_t2'
                                '+u12c_t1 +u12i_t1 +u12j_t1'
                                '+u12c_t2 +u12i_t2 +u12j_t2'
                                '+uh11rpc19 +uh11rpc19'
...
ax.set_title('Homoskedasticity Test- FE Estimation'
             ' Articles Group, United States', fontsize = 12)
plt.show()

print('Articles Group Estimation: United States')
print('Pooled OLS: Results')
reg_olsu = plm.PooledOLS.from_formula(formula='qpc ~ 1+ d_id_1 + ddest_2 +ddest_3'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+u11c_t1 +u11i_t1 +u11j_t1'
                                '+u11c_t2 +u11i_t2 +u11j_t2'
...
# print('White Test- Articles Group, United States')
# print(dict(zip(labels, white_test_results)))
# 3A.3 Breusch-Pagan-Test
breusch_pagan_test_results = het_breuschpagan(pooled_OLSu_dataset['residual'], exog)
labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
print('Breusch-Pagan Test- Articles Group, United States')
...
print(f'Durbin-Watson Test results- Articles Group, United States: \n{durbin_watson_test_results}\n')


print('Articles Group Estimation: United States')
print('Random Effects: Results')
reg_reu = plm.RandomEffects.from_formula(formula='qpc ~ 1+ d_id_1 + ddest_2 +ddest_3'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+u11c_t1 +u11i_t1 +u11j_t1'
                                '+u11c_t2 +u11i_t2 +u11j_t2'
...
# Excl. = ddest_(2)
# Excl. = h_(_) 
ar['c11u_t1'] = ar.d_id_2 * ar.h_11 *ar.ddest_1 *ar.tw1
ar['c11i_t1'] = ar.d_id_2 * ar.h_11 *ar.ddest_3 *ar.tw1
ar['c11j_t1'] = ar.d_id_2 * ar.h_11 *ar.ddest_4 *ar.tw1

ar['c11u_t2'] = ar.d_id_2 * ar.h_11 *ar.ddest_1 *ar.tw2
ar['c11i_t2'] = ar.d_id_2 * ar.h_11 *ar.ddest_3 *ar.tw2
ar['c11j_t2'] = ar.d_id_2 * ar.h_11 *ar.ddest_4 *ar.tw2

ar['c12u_t1'] = ar.d_id_2 * ar.h_12 *ar.ddest_1 *ar.tw1
ar['c12i_t1'] = ar.d_id_2 * ar.h_12 *ar.ddest_3 *ar.tw1
ar['c12j_t1'] = ar.d_id_2 * ar.h_12 *ar.ddest_4 *ar.tw1

ar['c12u_t2'] = ar.d_id_2 * ar.h_12 *ar.ddest_1 *ar.tw2
ar['c12i_t2'] = ar.d_id_2 * ar.h_12 *ar.ddest_3 *ar.tw2
ar['c12j_t2'] = ar.d_id_2 * ar.h_12 *ar.ddest_4 *ar.tw2

ar['ch11rpc19'] = ar.d_id_2 * ar.h_11 * ar.rp_e * ar.covid
ar['ch12rpc19'] = ar.d_id_2 * ar.h_12 * ar.rp_e * ar.covid 


#Using 'd_id_2' to indicate that we are specifying exports 
# originating from China;
# FE model estimation:
print('Articles Group Estimation: China')
print('Fixed Effects: Results')
reg_fec = plm.PanelOLS.from_formula(formula='qpc ~ d_id_2 +ddest_1'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+c11u_t1 +c11i_t1 +c11j_t1'
                                '+c11u_t2 +c11i_t2 +c11j_t2'
                                '+c12u_t1 +c12i_t1 +c12j_t1'
                                '+c12u_t2 +c12i_t2 +c12j_t2'
                                '+ch11rpc19 +ch12rpc19'
                                ,data = ar, drop_absorbed=True) 
...
ax.set_ylabel('Residuals', fontsize = 15)
ax.set_title('Homoskedasticity Test- FE Estimation'
             ' Articles Group, China', fontsize = 12)
plt.show()


print('Articles Group Estimation: China')
print('Pooled OLS: Results')
reg_olsc = plm.PooledOLS.from_formula(formula='qpc ~ 1+ d_id_2 +ddest_1'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+c11u_t1 +c11i_t1 +c11j_t1'
                                '+c11u_t2 +c11i_t2 +c11j_t2'
...
# labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
# print('White Test- PooledOLS: Articles Group, China')
# print(dict(zip(labels, white_test_results)))
# 3A.3 Breusch-Pagan-Test
breusch_pagan_test_results = het_breuschpagan(pooled_OLSc_dataset['residual'], exog)
labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
print('Breusch-Pagan Test- PooledOLS: Articles Group, China')
print(dict(zip(labels, breusch_pagan_test_results)))
...
print(f'Durbin-Watson Test results- Articles Group, China: \n{durbin_watson_test_results}\n')


print('Articles Group Estimation: China')
print('Random Effects: Results')
reg_rec = plm.RandomEffects.from_formula(formula='qpc ~ 1+ d_id_2 +ddest_1'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+c11u_t1 +c11i_t1 +c11j_t1'
                                '+c11u_t2 +c11i_t2 +c11j_t2'
...
# Excl. = ddest_(4)
# Excl. = h_(_) 
ar['j11u_t1'] = ar.d_id_4 * ar.h_11 *ar.ddest_1 *ar.tw1
ar['j11c_t1'] = ar.d_id_4 * ar.h_11 *ar.ddest_2 *ar.tw1
ar['j11k_t1'] = ar.d_id_4 * ar.h_11 *ar.ddest_5 *ar.tw1

ar['j11u_t2'] = ar.d_id_4 * ar.h_11 *ar.ddest_1 *ar.tw2
ar['j11c_t2'] = ar.d_id_4 * ar.h_11 *ar.ddest_2 *ar.tw2
ar['j11k_t2'] = ar.d_id_4 * ar.h_11 *ar.ddest_5 *ar.tw2

ar['j12u_t1'] = ar.d_id_4 * ar.h_12 *ar.ddest_1 *ar.tw1
ar['j12c_t1'] = ar.d_id_4 * ar.h_12 *ar.ddest_2 *ar.tw1
ar['j12k_t1'] = ar.d_id_4 * ar.h_12 *ar.ddest_5 *ar.tw1

ar['j12u_t2'] = ar.d_id_4 * ar.h_12 *ar.ddest_1 *ar.tw2
ar['j12c_t2'] = ar.d_id_4 * ar.h_12 *ar.ddest_2 *ar.tw2
ar['j12k_t2'] = ar.d_id_4 * ar.h_12 *ar.ddest_5 *ar.tw2

ar['jh11rpc19'] = ar.d_id_4 * ar.h_11 * ar.rp_e * ar.covid
ar['jh12rpc19'] = ar.d_id_4 * ar.h_12 * ar.rp_e * ar.covid 


#Using 'd_id_4' to indicate that we are specifying exports 
# originating from Japan;
# FE model estimation:
print('Articles Group Estimation: Japan')
print('Fixed Effects: Results')
reg_fej = plm.PanelOLS.from_formula(formula='qpc ~ d_id_4 +ddest_1 +ddest_2'
                                '+ddest_5 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+j11u_t1 +j11c_t1 +j11k_t1'
                                '+j11u_t2 +j11c_t2 +j11k_t2'
                                '+j12u_t1 +j12c_t1 +j12k_t1'
                                '+j12u_t2 +j12c_t2 +j12k_t2'
                                '+jh11rpc19 +jh12rpc19'
                                ,data = ar, drop_absorbed=True) 
...
ax.set_ylabel('Residuals', fontsize = 15)
ax.set_title('Homoskedasticity Test- FE Estimation'
             ' Articles Group, Japan', fontsize = 12)
plt.show()


print('Articles Group Estimation: Japan')
print('Pooled OLS: Results')
reg_olsj = plm.PooledOLS.from_formula(formula='qpc ~ 1+ d_id_4 +ddest_1 +ddest_2'
                                '+ddest_5 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+j11u_t1 +j11c_t1 +j11k_t1'
                                '+j11u_t2 +j11c_t2 +j11k_t2'
...
# labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
# print('White Test- PooledOLS: Articles Group, Japan')
# print(dict(zip(labels, white_test_results)))
# 3A.3 Breusch-Pagan-Test
breusch_pagan_test_results = het_breuschpagan(pooled_OLSj_dataset['residual'], exog)
labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
print('Breusch-Pagan Test- PooledOLS: Articles Group, Japan')
print(dict(zip(labels, breusch_pagan_test_results)))
...
print(f'Durbin-Watson Test results- Fabrics Group, Japan: \n{durbin_watson_test_results}\n')


print('Articles Group Estimation: Japan')
print('Random Effects: Results')
reg_rej = plm.RandomEffects.from_formula(formula='qpc ~ 1+ d_id_4 +ddest_1 +ddest_2'
                                '+ddest_5 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+j11u_t1 +j11c_t1 +j11k_t1'
                                '+j11u_t2 +j11c_t2 +j11k_t2'
...
# Excl. = ddest_(4)
# Excl. = h_(_)
ar['k11u_t1'] = ar.d_id_5 * ar.h_11 *ar.ddest_1 *ar.tw1
ar['k11c_t1'] = ar.d_id_5 * ar.h_11 *ar.ddest_2 *ar.tw1
ar['k11j_t1'] = ar.d_id_5 * ar.h_11 *ar.ddest_4 *ar.tw1

ar['k11u_t2'] = ar.d_id_5 * ar.h_11 *ar.ddest_1 *ar.tw2
ar['k11c_t2'] = ar.d_id_5 * ar.h_11 *ar.ddest_2 *ar.tw2
ar['k11j_t2'] = ar.d_id_5 * ar.h_11 *ar.ddest_4 *ar.tw2

ar['k12u_t1'] = ar.d_id_5 * ar.h_12 *ar.ddest_1 *ar.tw1
ar['k12c_t1'] = ar.d_id_5 * ar.h_12 *ar.ddest_2 *ar.tw1
ar['k12j_t1'] = ar.d_id_5 * ar.h_12 *ar.ddest_4 *ar.tw1

ar['k12u_t2'] = ar.d_id_5 * ar.h_12 *ar.ddest_1 *ar.tw2
ar['k12c_t2'] = ar.d_id_5 * ar.h_12 *ar.ddest_2 *ar.tw2
ar['k12j_t2'] = ar.d_id_5 * ar.h_12 *ar.ddest_4 *ar.tw2

ar['kh11rpc19'] = ar.d_id_5 * ar.h_11 * ar.rp_e * ar.covid
ar['kh12rpc19'] = ar.d_id_5 * ar.h_12 * ar.rp_e * ar.covid 

 
#Using 'd_id_5' to indicate that we are specifying exports 
# originating from Korea;
# FE model estimation:
print('Articles Group Estimation: Korea')
print('Fixed Effects: Results')
reg_fek = plm.PanelOLS.from_formula(formula='qpc ~ d_id_5 +ddest_1 +ddest_2'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+k11u_t1 +k11c_t1 +k11j_t1'
                                '+k11u_t2 +k11c_t2 +k11j_t2'
                                '+k12u_t1 +k12c_t1 +k12j_t1'
                                '+k12u_t2 +k12c_t2 +k12j_t2'
                                '+kh11rpc19 +kh12rpc19'
                                ,data = ar, drop_absorbed=True) 
...
ax.set_ylabel('Residuals', fontsize = 15)
ax.set_title('Homoskedasticity Test- FE Estimation'
             ' Articles Group, Korea', fontsize = 12)
plt.show()


print('Articles Group Estimation: Korea')
print('Pooled OLS: Results')
reg_olsk = plm.PooledOLS.from_formula(formula='qpc ~ 1+ d_id_5 +ddest_1 +ddest_2'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+k11u_t1 +k11c_t1 +k11j_t1'
                                '+k11u_t2 +k11c_t2 +k11j_t2'
...
# labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
# print('White Test- PooledOLS: Articles Group, Korea')
# print(dict(zip(labels, white_test_results)))
# 3A.3 Breusch-Pagan-Test
breusch_pagan_test_results = het_breuschpagan(pooled_OLSk_dataset['residual'], exog)
labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
print('Breusch-Pagan Test- PooledOLS: Articles Group, Korea')
print(dict(zip(labels, breusch_pagan_test_results)))
...
print(f'Durbin-Watson Test results- Articles Group, Korea: \n{durbin_watson_test_results}\n')



print('Articles Group Estimation: Korea')
print('Random Effects: Results')
reg_rek = plm.RandomEffects.from_formula(formula='qpc ~ 1+ d_id_5 +ddest_1 +ddest_2'
                                '+ddest_4 +h_11 +h_12'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+k11u_t1 +k11c_t1 +k11j_t1'
                                '+k11u_t2 +k11c_t2 +k11j_t2'
