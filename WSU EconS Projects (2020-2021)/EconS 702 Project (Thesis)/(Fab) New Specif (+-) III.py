...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 22 13:35:03 2021
...
# Excl. = ddest_(1)
# Excl. = h_(_) 
fa['u8c_t1'] = fa.d_id_1 * fa.h_8 *fa.ddest_2 *fa.tw1
fa['u8i_t1'] = fa.d_id_1 * fa.h_8 *fa.ddest_3 *fa.tw1
fa['u8j_t1'] = fa.d_id_1 * fa.h_8 *fa.ddest_4 *fa.tw1

fa['u8c_t2'] = fa.d_id_1 * fa.h_8 *fa.ddest_2 *fa.tw2
fa['u8i_t2'] = fa.d_id_1 * fa.h_8 *fa.ddest_3 *fa.tw2
fa['u8j_t2'] = fa.d_id_1 * fa.h_8 *fa.ddest_4 *fa.tw2

fa['u9c_t1'] = fa.d_id_1 * fa.h_9 *fa.ddest_2 *fa.tw1
fa['u9i_t1'] = fa.d_id_1 * fa.h_9 *fa.ddest_3 *fa.tw1
fa['u9j_t1'] = fa.d_id_1 * fa.h_9 *fa.ddest_4 *fa.tw1

fa['u9c_t2'] = fa.d_id_1 * fa.h_9 *fa.ddest_2 *fa.tw2
fa['u9i_t2'] = fa.d_id_1 * fa.h_9 *fa.ddest_3 *fa.tw2
fa['u9j_t2'] = fa.d_id_1 * fa.h_9 *fa.ddest_4 *fa.tw2

fa['uh2rpc19'] = fa.d_id_1 * fa.h_8 * fa.rp_e * fa.covid
fa['uh3rpc19'] = fa.d_id_1 * fa.h_9 * fa.rp_e * fa.covid 

#Using 'd_id_1' to indicate that we are specifying exports 
# originating from the United States;
# FE model estimation:
print('Fabrics Group Estimation: United States')  
...
reg_feu = plm.PanelOLS.from_formula(formula='qpc ~ d_id_1 +ddest_2 +ddest_3'
                                ...
                                '+u8c_t1 +u8i_t1 +u8j_t1'
                                '+u8c_t2 +u8i_t2 +u8j_t2'
                                '+u9c_t1 +u9i_t1 +u9j_t1'
                                '+u9c_t2 +u9i_t2 +u9j_t2'
                                '+uh2rpc19 +uh3rpc19'
                                ,data = fa, drop_absorbed=True) 
results_feu = reg_feu.fit()
...
ax.set_title('Homoskedasticity Test- FE Estimation'
             ' Fabrics Group, United States', fontsize = 12)
plt.show()
...
# print('White Test- Fabrics Group, United States')
# print(dict(zip(labels, white_test_results)))
# 3A.3 Breusch-Pagan-Test
breusch_pagan_test_results = het_breuschpagan(pooled_OLSu_dataset['residual'], exog)
labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
print('Breusch-Pagan Test- Fabrics Group, United States')
...
print(f'Durbin-Watson Test results- Fabrics Group, United States: \n{durbin_watson_test_results}\n')
...
# Excl. = ddest_(2)
# Excl. = h_(_)
fa['c8u_t1'] = fa.d_id_2 * fa.h_8 *fa.ddest_1 *fa.tw1
fa['c8i_t1'] = fa.d_id_2 * fa.h_8 *fa.ddest_3 *fa.tw1
fa['c8j_t1'] = fa.d_id_2 * fa.h_8 *fa.ddest_4 *fa.tw1

fa['c8u_t2'] = fa.d_id_2 * fa.h_8 *fa.ddest_1 *fa.tw2
fa['c8i_t2'] = fa.d_id_2 * fa.h_8 *fa.ddest_3 *fa.tw2
fa['c8j_t2'] = fa.d_id_2 * fa.h_8 *fa.ddest_4 *fa.tw2

fa['c9u_t1'] = fa.d_id_2 * fa.h_9 *fa.ddest_1 *fa.tw1
fa['c9i_t1'] = fa.d_id_2 * fa.h_9 *fa.ddest_3 *fa.tw1
fa['c9j_t1'] = fa.d_id_2 * fa.h_9 *fa.ddest_4 *fa.tw1

fa['c9u_t2'] = fa.d_id_2 * fa.h_9 *fa.ddest_1 *fa.tw2
fa['c9i_t2'] = fa.d_id_2 * fa.h_9 *fa.ddest_3 *fa.tw2
fa['c9j_t2'] = fa.d_id_2 * fa.h_9 *fa.ddest_4 *fa.tw2

fa['ch2rpc19'] = fa.d_id_2 * fa.h_8 * fa.rp_e * fa.covid
fa['ch3rpc19'] = fa.d_id_2 * fa.h_9 * fa.rp_e * fa.covid 

 
#Using 'd_id_2' to indicate that we are specifying exports 
# originating from China;
# FE model estimation:
print('Fabrics Group Estimation: China')
print('Fixed Effects: Results')
reg_fec = plm.PanelOLS.from_formula(formula='qpc ~ d_id_2 +ddest_1 +ddest_3'
                                '+ddest_4 +h_8 +h_9'
                                '+rp_e +exch +gpc'
                                '+c8u_t1 +c8i_t1 +c8j_t1'
                                '+c8u_t2 +c8i_t2 +c8j_t2'
                                '+c9u_t1 +c9i_t1 +c9j_t1'
                                '+c9u_t1 +c9i_t2 +c9j_t2'
                                '+ch2rpc19 +ch3rpc19'
                                ,data = fa, drop_absorbed=True) 
...
ax.set_ylabel('Residuals', fontsize = 15)
ax.set_title('Homoskedasticity Test- FE Estimation'
             ' Fabrics Group, China', fontsize = 12)
plt.show()


print('Fabrics Group Estimation: China')
print('Pooled OLS: Results')
reg_olsc = plm.PooledOLS.from_formula(formula='qpc ~ 1+ d_id_2 +ddest_1 +ddest_3'
                                '+ddest_4 +h_8 +h_9'
                                '+rp_e +exch +gpc'
                                '+c8u_t1 +c8i_t1 +c8j_t1'
                                '+c8u_t2 +c8i_t2 +c8j_t2'
...
# labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
# print('White Test- PooledOLS: Fabrics Group, China')
# print(dict(zip(labels, white_test_results)))
# 3A.3 Breusch-Pagan-Test
breusch_pagan_test_results = het_breuschpagan(pooled_OLSc_dataset['residual'], exog)
labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
print('Breusch-Pagan Test- PooledOLS: Fabrics Group, China')
print(dict(zip(labels, breusch_pagan_test_results)))
...
print(f'Durbin-Watson Test results- Fabrics Group, China: \n{durbin_watson_test_results}\n')


print('Fabrics Group Estimation: China')
print('Random Effects: Results')
reg_rec = plm.RandomEffects.from_formula(formula='qpc ~ 1+ d_id_2 +ddest_1 +ddest_3'
                                '+ddest_4 +h_8 +h_9'
                                '+rp_e +exch +gpc'
                                '+c8u_t1 +c8i_t1 +c8j_t1'
                                '+c8u_t2 +c8i_t2 +c8j_t2'
...
# Excl. = ddest_(4)
# Excl. = h_(_) 
fa['j8u_t1'] = fa.d_id_4 * fa.h_8 *fa.ddest_1 *fa.tw1
fa['j8c_t1'] = fa.d_id_4 * fa.h_8 *fa.ddest_2 *fa.tw1
fa['j8k_t1'] = fa.d_id_4 * fa.h_8 *fa.ddest_5 *fa.tw1

fa['j8u_t2'] = fa.d_id_4 * fa.h_8 *fa.ddest_1 *fa.tw2
fa['j8c_t2'] = fa.d_id_4 * fa.h_8 *fa.ddest_2 *fa.tw2
fa['j8k_t2'] = fa.d_id_4 * fa.h_8 *fa.ddest_5 *fa.tw2

fa['j9u_t1'] = fa.d_id_4 * fa.h_9 *fa.ddest_1 *fa.tw1
fa['j9c_t1'] = fa.d_id_4 * fa.h_9 *fa.ddest_2 *fa.tw1
fa['j9k_t1'] = fa.d_id_4 * fa.h_9 *fa.ddest_5 *fa.tw1

fa['j9u_t2'] = fa.d_id_4 * fa.h_9 *fa.ddest_1 *fa.tw2
fa['j9c_t2'] = fa.d_id_4 * fa.h_9 *fa.ddest_2 *fa.tw2
fa['j9k_t2'] = fa.d_id_4 * fa.h_9 *fa.ddest_5 *fa.tw2

fa['jh8rpc19'] = fa.d_id_4 * fa.h_8 * fa.rp_e * fa.covid
fa['jh9rpc19'] = fa.d_id_4 * fa.h_9 * fa.rp_e * fa.covid 

#Using 'd_id_4' to indicate that we are specifying exports 
# originating from Japan;
# FE model estimation:
print('Fabrics Group Estimation: Japan')
print('Fixed Effects: Results')
reg_fej = plm.PanelOLS.from_formula(formula='qpc ~ d_id_4 +ddest_1 +ddest_2'
                                '+ddest_3 +h_8 +h_9'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+j8u_t1 +j8c_t1 +j8k_t1'
                                '+j8u_t2 +j8c_t2 +j8k_t2'
                                '+j9u_t1 +j9c_t1 +j9k_t1'
                                '+j9u_t2 +j9c_t2 +j9k_t2'
                                '+jh8rpc19 +jh9rpc19'
                                ,data = fa, drop_absorbed=True) 
...
ax.set_ylabel('Residuals', fontsize = 15)
ax.set_title('Homoskedasticity Test- FE Estimation'
             ' Fabrics Group, Japan', fontsize = 12)
plt.show()
...
labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
print('Breusch-Pagan Test- PooledOLS: Fabrics Group, Japan')
print(dict(zip(labels, breusch_pagan_test_results)))
...
# Excl. = ddest_(4)
# Excl. = h_(_) 
fa['k8u_t1'] = fa.d_id_5 * fa.h_8 *fa.ddest_1 *fa.tw1
fa['k8c_t1'] = fa.d_id_5 * fa.h_8 *fa.ddest_2 *fa.tw1
fa['k8j_t1'] = fa.d_id_5 * fa.h_8 *fa.ddest_4 *fa.tw1

fa['k8u_t2'] = fa.d_id_5 * fa.h_8 *fa.ddest_1 *fa.tw2
fa['k8c_t2'] = fa.d_id_5 * fa.h_8 *fa.ddest_2 *fa.tw2
fa['k8j_t2'] = fa.d_id_5 * fa.h_8 *fa.ddest_4 *fa.tw2

fa['k9u_t1'] = fa.d_id_5 * fa.h_9 *fa.ddest_1 *fa.tw1
fa['k9c_t1'] = fa.d_id_5 * fa.h_9 *fa.ddest_2 *fa.tw1
fa['k9j_t1'] = fa.d_id_5 * fa.h_9 *fa.ddest_4 *fa.tw1

fa['k9u_t2'] = fa.d_id_5 * fa.h_9 *fa.ddest_1 *fa.tw2
fa['k9c_t2'] = fa.d_id_5 * fa.h_9 *fa.ddest_2 *fa.tw2
fa['k9j_t2'] = fa.d_id_5 * fa.h_9 *fa.ddest_4 *fa.tw2

fa['kh8rpc19'] = fa.d_id_5 * fa.h_8 * fa.rp_e * fa.covid
fa['kh9rpc19'] = fa.d_id_5 * fa.h_9 * fa.rp_e * fa.covid 


#Using 'd_id_5' to indicate that we are specifying exports 
# originating from Korea;
# FE model estimation:
print('Fabrics Group Estimation: Korea')
print('Fixed Effects: Results')
reg_fek = plm.PanelOLS.from_formula(formula='qpc ~ d_id_5 +ddest_1 +ddest_2'
                                '+ddest_4 +h_8 +h_9'
                                '+rp_e +exch +gpc +tw1 +tw2 +covid'
                                '+k8u_t1 +k8c_t1 +k8j_t1'
                                '+k8u_t2 +k8c_t2 +k8j_t2'
                                '+k9u_t1 +k9c_t1 +k9j_t1'
                                '+k9u_t2 +k9c_t2 +k9j_t2'
                                '+kh8rpc19 +kh9rpc19'
                                ,data = fa, drop_absorbed=True) 
...
ax.set_ylabel('Residuals', fontsize = 15)
ax.set_title('Homoskedasticity Test- FE Estimation'
             ' Fabrics Group, Korea', fontsize = 12)
plt.show()
...
# labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
# print('White Test- PooledOLS: Fabrics Group, Korea')
# print(dict(zip(labels, white_test_results)))
# 3A.3 Breusch-Pagan-Test
breusch_pagan_test_results = het_breuschpagan(pooled_OLSk_dataset['residual'], exog)
labels = ['LM-Stat', 'LM p-val', 'F-Stat', 'F p-val'] 
print('Breusch-Pagan Test- PooledOLS: Fabrics Group, Korea')
print(dict(zip(labels, breusch_pagan_test_results)))
...
print(f'Durbin-Watson Test results- Fabrics Group, Korea: \n{durbin_watson_test_results}\n')
